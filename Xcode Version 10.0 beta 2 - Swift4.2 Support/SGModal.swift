...
open class SGModal: UIView {
    ...
    fileprivate func setObservers() {
        NotificationCenter.default.addObserver(self, selector: #selector(SGModal.deviceOrientationDidChange(_:)), name: UIDevice.orientationDidChangeNotification, object: nil)
    }
    ...
    fileprivate func createContainerView() -> UIScrollView {
        ...
        for (index, item) in items.enumerated() {
            ...
            radioButton.setTitle(item.itemTitle, for: UIControl.State())
    ...
    fileprivate func createCloseButton() -> UIButton {
        ...
        button.addTarget(self, action: #selector(SGModal.close), for: UIControl.Event.touchUpInside )
